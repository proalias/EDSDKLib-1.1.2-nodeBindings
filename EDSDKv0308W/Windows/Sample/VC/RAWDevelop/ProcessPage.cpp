...
static STR_ID_TABLE s_tblWhiteBalance[] = {				
	...
	{ "Auto White",	kEdsWhiteBalance_AwbWhite }, 
...
static STR_ID_TABLE s_tblPictureStyle[] = {				
	...
	{ "Fine Detail",	kEdsPictureStyle_FineDetail }, 	
...
void CProcessPage::SetImageRef( EdsImageRef ref )
{
	...
	if( err == EDS_ERR_OK )
	{
		...
		SET_SLIDER( m_SaturationSlider , m_PicStyDesc.saturation , "%d" , IDC_EDIT7 );	// Saturation
...
void CProcessPage::OnBnClickedButton3()
{
	...
	if( err == EDS_ERR_OK )
	{
		...
		SET_SLIDER( m_SaturationSlider , desc.saturation , "%d" , IDC_EDIT7 );	// Saturation
